...
public class PawnMoves {
    ...
    public void makeMove(Move move, Board board) {
        if (pawnrules.enPassantCheck(move, board)) {
            enPassant(move, board); //If move is en passant calls en passant method to make it
        } else if (pawnrules.doubleMoveCheck(move, board)) {
            doubleMove(move, board); //If move is double move take calls double move method to make it
        } else if (pawnrules.promotionCheck(move, board)) {
            promotion(move, board); //If move is promotion calls promotion method to do it
        } else {
            move(move, board); //Calls move method to do the move
        }
